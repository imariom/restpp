 ...
 *
 * HTTP headers of a response or request.
 * 
 * For more information and updates, visit: https://github.com/imariom/restpp
 */

#pragma once
#ifndef RESTPP_HTTP_HEADERS_HPP
#define RESTPP_HTTP_HEADERS_HPP
...
private:
    using inner_container = std::map<utility::string_t, utility::string_t, _case_insensitive_cmp>;
